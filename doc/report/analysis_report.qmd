...
## Introduction {.unnumbered}
  ...
  Who has never watched shooting stars in the sky as a kid, wondering what they were and where they came from ? Growing up, we all learned that theses beautiful lights were due to the high-speed dust of meteorite coming in the atmosphere, before it inevitably destroys it. However, what would happen if it was not just the dust of the meteorit, but the meteorit itself coming straight to us through the atmosphere ? Wouldn't we like to know ? And if we do, could we avoid it ? At least, we know that the dinosaurs didn't ask themselves this question…
...
Finally, this application will be developed in Python, mainly through the VS Code editor made available on ENSAI's Onyxia (SSP Cloud) platformt.
